...
public class Punctuation
{
	...
	public void searchIt()
	{
		...
		punctuationWords = getPunctuationWords();
		printWords(punctuationWords);
	}
	public String getPunctuationWords()
	{
		System.out.print("\n\n\n");
		String message = new String("Blood, Sweat, and Tears by Winston Churchill " +
"May 13, 1940" +
"Mr. Speaker:" +
...
"and I say, \"Come then, let us go forward together with our united strength.\"");
		String individualWord = new String(""); 
		char charSplit = ' ';
		int startSpace = 0; 
		int endSpace = 0;
		...
		{
			charSplit = message.charAt(x); 
			if (charSplit==(' '))
			{
				endSpace = x;
				individualWord = message.substring(startSpace, endSpace); 
				startSpace = x;
			}
			checkForPunctuation(individualWord);
		}
	...
	public boolean checkForPunctuation(String word)
	{
		...
		{
			if (word.charAt(x) == punctuation.charAt(y))
			{
	...
	public void printWords(String finalWords)
	{
